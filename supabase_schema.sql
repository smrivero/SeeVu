-- ================================================================
-- SeeVu / Conversation AI — Supabase Schema
...
-- Deshabilitar RLS (proyecto privado, acceso solo por service role key)
...
-- ================================================================
-- Storage bucket: crear manualmente en el dashboard
-- Storage → New bucket
--   Name:   audio
--   Public: ON  (para que las URLs de audio funcionen directamente)
-- ================================================================
