...
class WebsocketClientApp {
  ...
  private static DEFAULT_WS_URL = 'http://localhost:7860/ws';
  private static WS_URL_STORAGE_KEY = 'pipecat-bot-ws-url';
  ...
  private setupDOMElements(): void {
    ...
    this.wsUrlInput = document.getElementById('ws-url') as HTMLInputElement;
  ...
  private getWsUrl(): string {
    const value = this.wsUrlInput?.value.trim() || WebsocketClientApp.DEFAULT_WS_URL;
